...
SOPCINFO_FILE := c:/Users/USUARIO/Documents/taller/FPGA-Microarquitectura-Reloj-Despertador/TimerWithClock.sopcinfo
...
# CPU Name 
# setting CPU_NAME is TimerWithClock
CPU_NAME = TimerWithClock
...
# Design Name 
# setting SOPC_NAME is TimerWithClock
SOPC_NAME := TimerWithClock
...
# setting hal.stdout is DEBUG
ELF_PATCH_FLAG  += --stdout_dev DEBUG
